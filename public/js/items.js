...
$(document).ready(function(){
   ...
   /**
    ...
    $("#editItemSubmit").click(function(){
        ...
        var itemLokasi = $("#itemLokasiEdit").val();
        var itemDesc = $("#itemDescriptionEdit").val();
        var itemPIC = $("#itemPICEdit").val();
        var itemNUP = $("#itemNUPEdit").val();
        var itemTahun = $("#itemTahunEdit").val();
        var itemKondisi = $("#itemKondisiEdit").val();
        var itemUnit =  $("#itemUnitEdit").val();



   
        if(!itemName || !itemCode || !itemKategori || !itemNUP || !itemKondisi || !itemUnit){
            !itemName ? $("#itemNameEditErr").html("Nama Tidak Boleh Kosong") : "";
            !itemCode ? $("#itemCodeEditErr").html("Kode  tidak boleh kosong") : "";
            !itemKategori ? $("#itemKategoriEditErr").html("kategori tidak boleh kosong") : "";
            !itemNUP ? $("#itemNUPEditErr").html("NUP tidak boleh kosong") : "";
            !itemKondisi ? $("#itemKondisiEditErr").html("Kondisi Barang tidak boleh kosong") : "";
            !itemUnit ? $("#itemUnitEditErr").html("Nama unit tidak boleh kosong") : "";
