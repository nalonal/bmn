...
class Item extends CI_Model{
 ...
 // }
   ...
   public function edit2($itemId, $itemName, $itemDesc, $itemPrice, $itemKategori, $itemQuantity, $itemMinimal, $barCode, $itemSatuan, $itemLokasi){
    ...
    public function edit($itemId,$itemName,$itemKategori,$barCode,$itemLokasi,$itemDesc,$itemPIC,$itemNUP,$itemTahun,$itemKondisi,$itemUnit,$itemCode){
        $data = [
            //new
            'name'=>$itemName,
            'kategori'=>$itemKategori,
